    ...
    return (
        <div className="w-full overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative border-t border-gray-100">
                {/* Horizontal Scroll Indicators (Visible on mobile only when scrollable) */}
                <div className="md:hidden absolute top-0 right-0 left-0 h-1 bg-gradient-to-r from-gray-50/0 via-primary/10 to-gray-50/0 opacity-50 z-40"></div>
